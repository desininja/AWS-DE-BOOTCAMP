...
def lambda_handler(event, context):
    ...
    try:
        ...
        respone = sns_client.publish(Subject="SUCCESS - Daily DoorDash Data Processing",TargetArn=sns_arn, Message=message, MessageStructure='text')
        return {
            'statusCode': 200,
        ...
        respone = sns_client.publish(Subject="FAILED!!!!! - Daily DoorDash Data Processing",TargetArn=sns_arn, Message=message, MessageStructure='text')
